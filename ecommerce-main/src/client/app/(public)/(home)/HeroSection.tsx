...
const HeroSection = ({ isPreview = false }: HeroSectionProps) => {
  ...
  const sliderData = [
    {
      image: SliderImg1,
      title: "Inbola'da Ajoyib Takliflar",
      subtitle: "Tanlangan mahsulotlarga 70% gacha chegirma",
    ...
    {
      image: SliderImg2,
      title: "Premium Sifatli Mahsulotlar",
      subtitle: "Sizning hayot tarzingiz uchun maxsus tanlangan",
      ctaText: "Ko'rish",
      ctaLink: "/shop",
    ...
    },
    {
      ...
      subtitle: "$50 dan ortiq buyurtmalarga",
      ctaText: "Batafsil",
      ctaLink: "/shop",
